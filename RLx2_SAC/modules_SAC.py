...
class DiagGaussianActor(nn.Module):
    ...
    def forward(self, state):
        ...
        log_std = self.max_action*log_std
...
class DiagGaussianActor(nn.Module):
    def __init__(self, state_dim, action_dim, hidden_dim, hidden_depth,
        ...
        self.log_std_bounds = log_std_bounds
        self.trunk = utils_SAC.mlp(state_dim, hidden_dim, 2 * action_dim,
                               hidden_depth)
...
class DoubleQCritic(nn.Module):
    ...
    def __init__(self, state_dim, action_dim, hidden_dim, hidden_depth):
        ...
        self.Q1 = utils_SAC.mlp(state_dim + action_dim, hidden_dim, 1, hidden_depth)
        self.Q2 = utils_SAC.mlp(state_dim + action_dim, hidden_dim, 1, hidden_depth)
